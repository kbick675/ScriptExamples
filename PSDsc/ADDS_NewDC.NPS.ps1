...
$scriptblock = {
    if (!((Get-ChildItem Cert:\LocalMachine\My\certhash) -and (Get-ChildItem Cert:\LocalMachine\TrustedPublisher\certhash)))
    {
    ...
    elseif (!((Get-ChildItem Cert:\LocalMachine\My\certhash) -and (Get-ChildItem Cert:\LocalMachine\TrustedPublisher\certhash)))
    {
