...
Configuration NewNdesServer
{
    ...
    Node $NodeName
    {
        ...
        { 
            ...
            CertificateID = 'certIDorThumbprint'
        }
        ...
        Script "InstallNDES"
        {
            ...
            SetScript = {
                ...
                Install-AdcsNetworkDeviceEnrollmentService -ApplicationPoolIdentity -SigningKeyLength 2048 -RAName "$($NDESName)-MSCEP-RA" -RAEmail "hostmasters@domaon.com" -RACompany "domaon" -RADepartment "IT" -RACity "Hawthorne" -RAState "CA" -RACountry "US" -EncryptionKeyLength 2048 -CAConfig "ca-iss1.domaon.corp\domaon Issuing CA"
            }
...
$Config = @{
    AllNodes = @(
        @{
            ...
            Thumbprint = 'thumbpring'
            #Template = "MobileDeviceScep"
            #Template = "domaonWebServer"
        }
    )
}
